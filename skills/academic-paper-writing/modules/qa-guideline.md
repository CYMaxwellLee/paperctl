...
⚠️ **本項原本是一份七級「頁數壓縮優先順序」（§4.1 Implementation Details 移 Supp → §4.5 → §3.x → …）。主人 2026-07-29 裁定那是幻覺，已整段刪除。** 它不是主人訂的規則，是先前版本的我編出來寫進 skill 當權威的，而 AAAI 交件日我正是照它自行砍了內容。⛔ 不要復原，也不要改寫成「經同意後才用」的版本。
