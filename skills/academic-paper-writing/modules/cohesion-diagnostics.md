...
- 改寫完一段之後
- 整節 line-edit 的時候
- 教授說「這裡讀起來怪／不順／接不太上」的時候

教授 2026-07-28（FOCUS §3.2）：「我感覺下面開始**因果關係接不太順不太好讀**」。
...
> 教授原話「缺個 transition?」）。那條長期只活在 rebuttal skill，未 propagate 到論文寫作，
> 於 2026-07-28 補進本模組。
...
**教授當場問法**（2026-07-28，§3.2）：「It **指誰**」。同一次還問了
