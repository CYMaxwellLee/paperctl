...
- **句式看功能，不背字典（2026-07-06 教授修正）**：銜接與結構性動作的驗收標準是
  **功能與流暢**——連接是否成立、讀起來是否專業順暢、重點痛點是否講清楚——而
  不是用了哪個句式。To this end / Motivated by / Enlightened by / Building on…
  都可以。教授原話：「不一定 always 要這樣寫…不要死背」「我沒有一定要『避開老套
  句式』，我在意的是論文是否寫得專業寫得流暢，能把重點痛點都講清楚」。¶4 三輪
  教訓的正確讀法不是「傳統句式贏」，是「先把連接的**功能**做出來」；學生稿裡
  已經做對功能的句子，拆掉前先想清楚。**任何下游不得把本條或帳本例句固化成
  句式清單給模型背**——反降維鐵則的直接應用。
- **全文等強審查，middles 也要順（2026-07-06 教授修正）**：段落中間句與句的
  transition 同樣要流暢（教授：「sentences 之間的 transition 做得更流暢我會覺得
  更好」）。**教授沒糾正 ≠ 教授核可**——他的糾正是最痛問題的抽樣，不是完整清單，
  不可從「他沒改哪裡」反推品味邊界。鏈讀與 Proxy 對全文等強執行；段落邊界只是
  歷史高風險區，不是唯一戰場。
